...
const AreaChartExample = ({ isAnimationActive = true, data }: AreaChartPropS) => {
    ...
    return (
        <div className='py-2 cursor-pointer w-full min-h-[65vh] my-5 px-4 bg-bg-color/5 rounded-2xl shadow-2xl drop-shadow-2xl border border-border-color/20 backdrop-blur-2xl hover:shadow-bg-color/30 transition-all duration-150'>
            <AreaChart
